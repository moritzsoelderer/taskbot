...
if __name__ == "__main__":
    ...
    # pose = rc.find_pose(0)
    import numpy as np
    pose = (np.array([ 0.09879765, -0.18563309,  0.5832366 ]), np.array([ 0.01061608, -0.98779323,  0.13917118,  0.93102385, -0.02910028,
       -0.31417241,  0.31654478,  0.13972619,  0.91934647]))
    print(pose)

    # rc.distance_less_then_threshold(pose)
    # rc.move_gripper_to_pose(pose, grasp=True)
